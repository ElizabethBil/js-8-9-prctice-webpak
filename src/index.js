...
function addToLocalStorage(listItema) {
    localStorage.setItem("listItems", JSON.stringify(listItema))
}
...
const clearStringBtn = document.querySelector(".clear");

clearStringBtn.addEventListener("click", () => {
